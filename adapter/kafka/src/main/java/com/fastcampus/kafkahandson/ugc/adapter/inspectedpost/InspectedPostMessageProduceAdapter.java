...
import static com.fastcampus.kafkahandson.ugc.adapter.common.Topic.INSPECTED_TOPIC;
...
public class InspectedPostMessageProduceAdapter implements InspectedPostMessageProducePort {
    ...
    @Override
    public void sendDeleteMesssage(Long postId) {
        InspectedPostMessage message = new InspectedPostMessage(postId, null, OperationType.DELETE);
        this.sendMessage(message);
    }
